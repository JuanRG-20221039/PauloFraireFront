      ...
      <div className="max-w-5xl mx-auto p-4 mt-10 shadow-lg">
        {loading ? (
          <div className="flex flex-col items-center justify-center min-h-[300px]">
            <Spinner />
            <p className="text-sm text-gray-500 mt-4">Cargando información...</p>
          </div>
        ) : (
            ...
            <div className="flex flex-col gap-4 justify-between">
              <div className="flex gap-2">
                <div className="w-full">
                  <label htmlFor="name" className="font-semibold text-slate-700 pb-2">Nombre:</label>
                  <input
                    type="text"
                    name="name"
                    id="name"
                ...
                <div className="w-full">
                  <label htmlFor="lastName" className="font-semibold text-slate-700 pb-2">Apellido:</label>
                  <input
                    type="text"
                    name="lastName"
                    id="lastName"
              ...
              <div className="flex gap-2">
                <div className="w-full">
                  <label htmlFor="email" className="font-semibold text-slate-700 pb-2">Correo:</label>
                  <input
                    type="email"
                    name="email"
                    id="email"
                ...
                <div className="w-full">
                  <label htmlFor="rol" className="font-semibold text-slate-700 pb-2">Rol:</label>
                  <select
                    name="rol"
                    id="rol"
                    className="input-auth"
              ...
              <div className="flex gap-2">
                <div className="w-full">
                  <label htmlFor="password" className="font-semibold text-slate-700 pb-2">Contraseña:</label>
                ...
                <div className="w-full">
                  <label htmlFor="password2" className="font-semibold text-slate-700 pb-2">Repetir Contraseña:</label>
                  <div className="relative">
                    <input
                      type={showPassword ? 'text' : 'password'}
                      name="password2"
